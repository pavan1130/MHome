  ...
  return (
    <ScrollView contentContainerStyle={styles.cardContainer}>
      {userData.map(Education => (
        <View key={Education.id} style={styles.card}>
          <Image source={{uri: Education.imageUrl}} style={styles.userImage} />
          <Text style={styles.userName}>{Education.name}</Text>
          <Text style={styles.userDesignation}>{Education.designation}</Text>
          <Text style={styles.userAvailability}>
            {Education.availability === 'Available'
              ? 'Available'
              : 'Not Available'}
          </Text>
          ...
          <View style={styles.keyValueRow}>
            <KeyValueContainer
              ...
              value={Education.overAttendance}
            />
            <KeyValueContainer
              label="Average Ratings"
              value={Education.averageRatings}
            />
            <KeyValueContainer
              label="Sessions Completed"
              value={Education.sessionsCompleted}
            />
          </View>
          <TouchableOpacity
            onPress={() => handleSave(Education.id)}
      ...
      <ScrollView>
        <View style={styles.appNameContainer}>
          ...
          <View style={styles.appNameTextContainer}>
            <Text style={styles.appNameText}>Education & Academics</Text>
          </View>
        </View>
...
export default Education_Academics;
