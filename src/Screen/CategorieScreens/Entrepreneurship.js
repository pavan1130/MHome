...
const UserCard = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.cardContainer}>
      {userData.map(Enterp => (
        <View key={Enterp.id} style={styles.card}>
          <Image source={{uri: Enterp.imageUrl}} style={styles.userImage} />
          <Text style={styles.userName}>{Enterp.name}</Text>
          <Text style={styles.userDesignation}>{Enterp.designation}</Text>
          <Text style={styles.userAvailability}>
            {Enterp.availability === 'Available'
              ? 'Available'
              : 'Not Available'}
          </Text>
          ...
          <View style={styles.keyValueRow}>
            <KeyValueContainer
              ...
              value={Enterp.overAttendance}
            />
            <KeyValueContainer
              label="Average Ratings"
              value={Enterp.averageRatings}
            />
            <KeyValueContainer
              label="Sessions Completed"
              value={Enterp.sessionsCompleted}
            />
          </View>
          <TouchableOpacity
            onPress={() => handleSave(Enterp.id)}
      ...
      <ScrollView>
        <View style={styles.appNameContainer}>
          ...
          <View style={styles.appNameTextContainer}>
            <Text style={styles.appNameText}>Entrepreneurship</Text>
          </View>
        </View>
