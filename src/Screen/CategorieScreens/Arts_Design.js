...
const UserCard = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.cardContainer}>
      {userData.map(Arts => (
        <View key={Arts.id} style={styles.card}>
          <Image source={{uri: Arts.imageUrl}} style={styles.userImage} />
          <Text style={styles.userName}>{Arts.name}</Text>
          <Text style={styles.userDesignation}>{Arts.designation}</Text>
          <Text style={styles.userAvailability}>
            {Arts.availability === 'Available' ? 'Available' : 'Not Available'}
          </Text>
          <Text style={styles.price}>$45/month</Text>
          <View style={styles.keyValueRow}>
            <KeyValueContainer
              label="Overall Attendance"
              value={Arts.overAttendance}
            />
            <KeyValueContainer
              label="Average Ratings"
              value={Arts.averageRatings}
            />
            <KeyValueContainer
              label="Sessions Completed"
              value={Arts.sessionsCompleted}
            />
          </View>
          <TouchableOpacity
            onPress={() => handleSave(Arts.id)}
      ...
      <ScrollView>
        <View style={styles.appNameContainer}>
          ...
          <View style={styles.appNameTextContainer}>
            <Text style={styles.appNameText}>Arts & Design</Text>
          </View>
        </View>
