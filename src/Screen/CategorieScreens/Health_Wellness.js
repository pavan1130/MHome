...
const UserCard = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.cardContainer}>
      {userData.map(health => (
        <View key={health.id} style={styles.card}>
          <Image source={{uri: health.imageUrl}} style={styles.userImage} />
          <Text style={styles.userName}>{health.name}</Text>
          <Text style={styles.userDesignation}>{health.designation}</Text>
          ...
          <View style={styles.keyValueRow}>
            <KeyValueContainer
              ...
              value={health.overAttendance}
            />
            <KeyValueContainer
              label="Average Ratings"
              value={health.averageRatings}
            />
            <KeyValueContainer
              label="Sessions Completed"
              value={health.sessionsCompleted}
            />
          </View>
          <TouchableOpacity
            onPress={() => handleSave(health.id)}
      ...
      <ScrollView>
        <View style={styles.appNameContainer}>
          ...
          <View style={styles.appNameTextContainer}>
            <Text style={styles.appNameText}>Health & Wellness</Text>
          </View>
        </View>
