    ...
    <ScrollView contentContainerStyle={styles.cardContainer}>
      {userData.map(Tech => (
        <View key={Tech.id} style={styles.card}>
          <Image source={{uri: Tech.imageUrl}} style={styles.userImage} />
          <Text style={styles.userName}>{Tech.name}</Text>
          <Text style={styles.userDesignation}>{Tech.designation}</Text>
          <Text style={styles.userAvailability}>
            {Tech.availability === 'Available' ? 'Available' : 'Not Available'}
          </Text>
          <Text style={styles.price}>$45/month</Text>
          <View style={styles.keyValueRow}>
            <KeyValueContainer
              label="Overall Attendance"
              value={Tech.overAttendance}
            />
            <KeyValueContainer
              label="Average Ratings"
              value={Tech.averageRatings}
            />
            <KeyValueContainer
              label="Sessions Completed"
              value={Tech.sessionsCompleted}
            />
          </View>
          <TouchableOpacity
            onPress={() => handleSave(Tech.id)}
      ...
      <ScrollView>
        <View style={styles.appNameContainer}>
          ...
          <View style={styles.appNameTextContainer}>
            <Text style={styles.appNameText}>Technology & Coding</Text>
          </View>
        </View>
...
export default Technology_Coding;
