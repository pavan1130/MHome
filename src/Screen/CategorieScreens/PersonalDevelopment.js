...
const UserCard = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.cardContainer}>
      {userData.map(Personal => (
        <View key={Personal.id} style={styles.card}>
          <Image source={{uri: Personal.imageUrl}} style={styles.userImage} />
          <Text style={styles.userName}>{Personal.name}</Text>
          <Text style={styles.userDesignation}>{Personal.designation}</Text>
          ...
          <View style={styles.keyValueRow}>
            <KeyValueContainer
              ...
              value={Personal.overAttendance}
            />
            <KeyValueContainer
              label="Average Ratings"
              value={Personal.averageRatings}
            />
            <KeyValueContainer
              label="Sessions Completed"
              value={Personal.sessionsCompleted}
            />
          </View>
          <TouchableOpacity
            onPress={() => handleSave(Personal.id)}
